...
:since:  v0.1.00
		...
		if (self.debug != None): self.debug.append ("phpBuilder/#echo(__FILEPATH__)# -phpBuilder.data_parse (data)- (#echo(__LINE__)#)")
...
:since:  v0.1.00
		...
		if (self.debug != None): self.debug.append ("phpBuilder/#echo(__FILEPATH__)# -phpBuilder.data_remove_dev_comments (data)- (#echo(__LINE__)#)")
		return re.sub ("(/\* ---.+?--- \*/\n\n)|(/\*\*\n.+?\n\*/\n)","",data,0,re.S)
	#
...
:since:  v0.1.00
		...
		if (self.debug != None): self.debug.append ("phpBuilder/#echo(__FILEPATH__)# -phpBuilder.parser_change (tag_definition,data,{0:d},{1:d},{2:d})- (#echo(__LINE__)#)".format (tag_position,data_position,tag_end_position))
...
:since:  v0.1.00
		...
		if (self.debug != None): self.debug.append ("phpBuilder/#echo(__FILEPATH__)# -phpBuilder.parser_check (data)- (#echo(__LINE__)#)")
		f_return = None
